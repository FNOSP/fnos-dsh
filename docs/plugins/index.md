...
| 包名 | 版本 | 适用场景 | 文档 | 源码 |
| --- | --- | --- | --- | --- |
| `@tnnevol/dsh-codex-auth` | `0.1.5-rc.2` | 使用 ChatGPT 账号登录 Codex，并把模型、用量和图片输入能力接入 DSH | [Codex Auth](/plugins/dsh-codex-auth) | [GitHub](https://github.com/FNOSP/fnos-dsh/tree/main/plugins/dsh-codex-auth-plugin) |
