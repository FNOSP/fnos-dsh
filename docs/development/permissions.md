...
```json
{
  ...
  "username": "fn-deepseek-harness",
  "groupname": "fn-deepseek-harness"
}
```
...
{
  ".url": {
    "fn-deepseek-harness.Application": {
      "title": "DeepSeek Harness",
      "icon": "images/icon_{0}.png",
      "type": "iframe",
      "protocol": "",
      "gatewayPrefix": "/app/fn-deepseek-harness",
      "gatewaySocket": "app.sock",
      "url": "/app/fn-deepseek-harness",
      "allUsers": false
    }
  }
}
...
| `gatewayPrefix` / `gatewaySocket` | 统一网关前缀和 socket | 与 `cmd/main` 注册的网关路径一致，仅网关应用使用 |
