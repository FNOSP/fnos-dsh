...
| FNOS-001-15 | P1 | 会话日志导出 | 保留电脑下载，并支持导出 ZIP 到授权 NAS 目录 | <Badge type="tip" text="已完成验证" /> |
...
| 会话日志 | 电脑导出复用 DSH 原生流程，NAS 导出只能写入已授权目录。 |
